  ...
  return (
    <div style={{ padding: '2rem', backgroundColor: '#fffaf5', fontFamily: 'Noto Sans JP' }}>
      ...
      <section style={{ marginBottom: '2rem' }}>
        <h2>1. あなたに合う職業（例）</h2>
        <ul>
          {Object.entries(scores).sort((a,b)=>b[1]-a[1]).slice(0, 2).flatMap(([factor]) =>
      ...
      <section style={{ marginTop: '2rem' }}>
        <h2>3. 向いている趣味</h2>
        <p>
          {scores["開放性"] > 3.5 ? "旅行、写真、創作活動、博物館巡り" :
           scores["外向性"] > 3.5 ? "カフェ巡り、スポーツ、ボランティア、フェス" :
           "読書、散歩、音楽鑑賞、家庭菜園"}
        </p>
      ...
      <section style={{ marginTop: '2rem' }}>
        <h2>4. 相性の良い友達タイプ</h2>
        <p>
          {scores["協調性"] > 3.5 ? "思いやりのある温厚な人、聞き上手タイプ" :
           scores["外向性"] > 3.5 ? "明るくてエネルギッシュな人、好奇心旺盛なタイプ" :
